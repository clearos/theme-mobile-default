...
/**
 * Header handler for the ClearOS mobile theme.
 *
 * @category  Theme
...
";
    ...
    $links = "<a href='/app/base/theme/set/mobile_default' data-role='button' data-icon='gear' rel='external'>" . lang('base_full_view') . "</a>";
